...
public class FirstPageUIForm {
    ...
    public void DevInfoOnAction(ActionEvent actionEvent) throws IOException {
        Stage stage = new Stage();
        stage.setScene(new Scene(FXMLLoader.load(getClass().getResource("../view/DevInfoForm.fxml"))));
        stage.show();
    }
}
